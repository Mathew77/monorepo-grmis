...
type RHFSelectProps = TextFieldProps & {
  ...
  sx?: SxProps; // Accept additional sx from other props
};
...
export function RHFSelect({
  ...
  helperText,
  slotProps = {},
  showShrinkLabel = false,
  sx = {}, // Accept additional sx from other props
  ...other
}: RHFSelectProps) {
  ...
  const shrinkStyles: SxProps = showShrinkLabel
    ? {}
    : {
        '& legend': { display: 'none' },
...
type RHFMultiSelectProps = FormControlProps & {
  ...
  minHeight?: number | string; // Add minHeight property
  slotProps?: {
    chip?: ChipProps;
    select?: SelectProps;
