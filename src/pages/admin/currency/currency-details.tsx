...
import CurrencyDetailsView from 'src/sections/admin/currency/currency-details-view';
...
const metadata = { title: `Currency Details - ${CONFIG.appName}` };
            ...
            <Grid container direction="column" rowSpacing={1}>
                <Grid size={12}>
                    ...
                    <Typography variant="body2" color="textSecondary">
                        Fill in the details for the currency. Ensure all required fields are completed before
                        saving.
                    </Typography>
                </Grid>
                <Grid size={12}>
