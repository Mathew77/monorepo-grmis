...
import { Typography, TextField, MenuItem, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Button } from '@mui/material';
...
export default function FundOpportunitiesListView() {
          ...
          <TableBody>
            {filteredData.map((row, index) => (
              <TableRow key={row.id}>
                ...
                <TableCell>
                  <Button variant="text" sx={{ color: '#F44336', textTransform: 'none' }} onClick={() => navigate(paths.fund.detail)}>View details</Button>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
